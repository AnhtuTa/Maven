...
<body>
	<div class="wrapper">
		...
		<div class="inner_wrapper">
			...
			<div class="photo_div">
				<img alt="Ảnh 3x4: sinh viên này chưa có ảnh!" width="200px;" src="${pageContext.request.contextPath}/student-photo?studentID=${st.id}"><br>  	<!-- ko dung: src="images/students/${st.id}.jpg" -->
				<br><div style="width: 200px;"><a href="change-student-photo?studentID=${st.id}">Change this student's photo</a></div>
			</div>
