			...
			<div style="margin: 5px; color: red;">${errorString}</div>
				...
				<%
					...
					for(int i = 0; i < courseList.size(); i++) {
						...
						<div class="div_coursename" style="margin-top: 30px;">
							Mã lớp học: <b><%=c.getCourseID() %></b>
							<span style="padding-left: 20px;">Mã HP: <b><%=c.getSubjectID() %></b></span>
							<span style="padding-left: 20px;">Max ĐK: <b><%=c.getMaxNum() %></b></span>
							<span style="padding-left: 20px;">Đã ĐK: <b><%=c.getRegisteredNum() %></b></span>
						</div>
